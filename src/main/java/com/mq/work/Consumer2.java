...
public class Consumer2 {
    ...
    public void consume() throws IOException, TimeoutException {
        ...
        channel.queueDeclare("Work_Test01",true,false,false,null);
        ...
        //参数1:queue - 指定消费队列名称
        //参数2:deliverCallback (autoACK)- 指定是否自动ACK(true:接收消费后,会立即告诉RabbitMQ,这个消息已经被消费了;false:接收消息后,需要手动告诉RabbitMQ)
        //参数3:cancelCallback - 指定消费回调函数consumer
        channel.basicConsume("Work_Test01",false,consumer);
